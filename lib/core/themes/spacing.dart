...
class AppSpacing {
  ...
  static const double bottomNavigationBarMargin = md; // 添加底部导航栏边距
  ...
  static EdgeInsets get symmetricHorizontalMd => const EdgeInsets.symmetric(horizontal: md);
  static EdgeInsets get symmetricVerticalMd => const EdgeInsets.symmetric(vertical: md);
  static EdgeInsets get symmetricHorizontalLg => const EdgeInsets.symmetric(horizontal: lg);
  static EdgeInsets get symmetricVerticalLg => const EdgeInsets.symmetric(vertical: lg);
